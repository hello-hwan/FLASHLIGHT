<template>
    <span style="margin-left:20px">
        <span>거래처 명</span>
        <InputText type="text" class="emp_info" @click="modalOpen" readonly placeholder="거래처 명을 입력해주세요"></InputText>
        <span>거래처 코드</span>
        <InputText type="text" class="emp_info" @click="modalOpen"readonly placeholder="거래처 코드를 입력해주세요"></InputText>

<template>
        ...
        <v-card class="mx-auto card-custom-1" style="border-radius:13px; text-align: center;">
            ...
            <v-card-text class="bg-surface-light pt-4">
                ...
                <button type="button" class="btn btn-primary"
                    style="color: white; margin: 10px; padding: 2px; width: 150px;" @click="add_eqp_btn()">기기 추가
                    등록</button>
    ...
    <span style="margin-left:20px; margin-bottom:0; margin-top:0;">
        <div class="modal-wrap" @click="modal_close_btn()" v-show="modal_on_off">
            <div>
                <v-card @click.stop="" class="modal-container mx-auto card-custom-1"
                    style="border-radius:13px; text-align: center; position: relative; top: 400px;left: 40%;">
                    <template v-slot:title>
                        <span class="font-weight-black">
                            설비 추가 등록
                        </span>
                    ...
                    <v-card-text class="bg-surface-light pt-4">
                        ...
                        <div class="modal-btn" style="display:flex; justify-content: center;">
                            <button @click="modal_close_btn()" class="btn btn-secondary"
                                style="margin: 5px; padding: 2px; width: 75px;">닫기</button>
                            <button @click="modal_submit_btn()" class="btn btn-primary"
                                style="margin: 5px; padding: 2px; width: 75px;">등록</button>
                        </div>
                    </v-card-text>
                </v-card>
            </div>
